...
<template>
  <el-config-provider namespace="map-debug">
    <div class="DebugMap" ref="refWrap">
      <div style="height: 500px;width: 500px; border: 1px solid #3b9bf3;display: flex;flex-direction: column" v-if="mapOk">
        <div class="header" style="background: #3b9bf3;height: 35px;padding-left:15px;display: flex;align-items: center" @mousedown="onMouseDown">
